package introducao.collections.pilha_e_fila;
...
public class Exemplo_pilha {
	...
	public static void main(String[] args) {
		...
		pilha.push("Prato Verde"); //mesma coisa que o .add  
		...
		System.out.println("\nElemento no topo da Pilha: " + pilha.peek()); //motra o proximo item
		
		System.out.println("\nAdicionar Elemento Prato Roxo: " + pilha.push("Prato Roxo")); //adiciona 
